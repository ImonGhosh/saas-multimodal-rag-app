...
In the image there are two tables. The first table is named Model Registry and the second table is named Training Pipeline. In the Model Registry table, there is a blue box with the text Data Layer and in the Training Pipeline table, there is a blue box with the text Redis Cache.
...
The image is a rectangular chart titled "Monitoring" with a white background. The chart has a grid-like structure with a single horizontal axis labeled "Datadog" and a vertical axis labeled "Sentry." The x-axis is labeled "Time," and the y-axis is labeled "Prometheus."

**Chart Elements:**
- **Title:** "Monitoring"
- **X-Axis:** Labeled "Time"
- **Y-Axis:** Labeled "Sentry"
- **Grid-like Structure:** Horizontal
- **Grid-lines:** White
- **Grid-lines:** White
- **Grid-lines:** White
- **Grid-lines:** White
